export const styles : Record<string, string> = {
    ...
    modalContent: 'flex flex-col items-center bg-linear-to-b from-purple-800 to-purple-900 rounded-lg shadow-lg w-1/3 max-w-[600px] min-w-[300px] h-4/5 max-h-[90vh] min-h-[300px] overflow-auto',
    ...
    answerButton: 'bg-gray-300 hover:bg-gray-400 hover:text-purple-600 text-purple-800 text-2xl font-bold rounded my-2 w-1/4 h-1/8 min-w-116 min-h-30 justify-self-center mx-4 my-4',
    correctAnswer: 'bg-green-500 text-white',
    wrongAnswer: 'bg-red-500 text-white',
}
