export const styles : Record<string, string> = {
    ...
    answerButton: 'hover:bg-gray-400 hover:text-purple-600 text-purple-800 text-2xl font-bold rounded my-2 w-1/4 h-1/8 min-w-116 min-h-30 justify-self-center mx-4 my-4',
}
